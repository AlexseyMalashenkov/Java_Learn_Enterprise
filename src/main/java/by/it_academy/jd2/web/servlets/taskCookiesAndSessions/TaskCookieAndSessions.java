package by.it_academy.jd2.web.servlets.taskCookiesAndSessions;

import by.it_academy.jd2.core.dto.LoadType;
import by.it_academy.jd2.core.dto.PersonDto;
import by.it_academy.jd2.web.servlets.taskCookiesAndSessions.utils.Cookies;
import by.it_academy.jd2.web.servlets.taskCookiesAndSessions.utils.Sessions;
...
public class TaskCookieAndSessions extends HttpServlet {
    ...
    private void writeWeb(String firstNameVal, String lastNameVal, String ageVal, HttpServletResponse resp) throws IOException {
        PersonDto personDto = new PersonDto(firstNameVal, lastNameVal, Integer.parseInt(ageVal));

        resp.setContentType("text/html");
        PrintWriter writer = resp.getWriter();
        writer.write("<p><span style='color: blue;'>Hello, " + personDto.toString() + " !</span></p>");
    }
}
